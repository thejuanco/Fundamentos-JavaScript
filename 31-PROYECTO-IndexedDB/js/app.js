...
function nuevaCita(e) {
    ...
    if(editando) {
        ...
        //Agregar registros en la base de datos (indexDB) 
        const transaction = DB.transaction(['citas'], 'readwrite')
        ...
        transaction.oncompleted = () => {
            console.log('Cita added successfully')
...
function crearDB(){
    //Crear la base de datos en V.1.0
    ...
    crearDB.onupgradeneeded = function(e){
        ...
        console.log('Base de datos create y lista')
    }
